...
`chemnet` also provides a function `deeriv_function` to get a derivative function compatible with the `deSolve` R package, which contains a number of numerical integrators.
...
You can then plot the solution using a few `tidyverse` packages fairly easily.
